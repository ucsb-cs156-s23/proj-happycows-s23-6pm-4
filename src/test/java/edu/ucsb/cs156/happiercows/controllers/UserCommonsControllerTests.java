...
public class UserCommonsControllerTests extends ControllerTestCase {
  ...
  public static UserCommons dummyUserCommons(long id) {
    UserCommons userCommons = new UserCommons(id,1,1,"test",1,1, 100,0,0);
    return userCommons;
  }
  ...
  @WithMockUser(roles = { "USER" })
  @Test
  public void test_BuyCow_commons_exists_buy_zero_cows() throws Exception {
  ...
  public void test_SellCow_commons_exists_no_cow_to_sell() throws Exception {
    ...
    @WithMockUser(roles = { "USER" })
  @Test
  public void test_SellCow_commons_exists_sell_zero_cows() throws Exception {
